<?php $__env->startSection('content'); ?>
        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <div style="padding-bottom: 10px;">
                    <?php if (\Illuminate\Support\Facades\Blade::check('allow', 'backend.user.create')): ?>
                        <button class="layui-btn" data-type="add">添加</button>
                    <?php endif; ?>
                    <button class="layui-btn" id="export">导出</button>
                    <?php if (\Illuminate\Support\Facades\Blade::check('allow', 'backend.user.destroy')): ?>
    ...
    <script type="text/html" id="barDemo">
        <?php if (\Illuminate\Support\Facades\Blade::check('allow', 'backend.user.edit')): ?>
    ...
    <script>
        ...
        layui.config({
            ...
            var dataTable = table.render({
                elem: '#dataTable'
                ,id: 'backendUser'
                ,url: "<?php echo e(route('backend.user.list')); ?>" //数据接口
                ,where: {
                    'username': username,
                    'mobile': mobile,
                    'role': role
...
<?php echo $__env->make('backend.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\phpStudy_64\phpstudy_pro\WWW\www.kbframe.com\resources\views/backend/user/index.blade.php ENDPATH**/ ?>