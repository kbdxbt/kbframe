<?php $__env->startSection('content'); ?>
        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <div style="padding-bottom: 10px;">
                    <?php if (\Illuminate\Support\Facades\Blade::check('allow', 'backend.announce.create')): ?>
                        <button class="layui-btn" data-type="add">添加</button>
                    <?php endif; ?>
                    <?php if (\Illuminate\Support\Facades\Blade::check('allow', 'backend.announce.destroy')): ?>
    ...
    <script type="text/html" id="barDemo">
        <?php if (\Illuminate\Support\Facades\Blade::check('allow', 'backend.announce.edit')): ?>
    ...
    <script>
        layui.config({
            ...
            var dataTable = table.render({
                elem: '#dataTable'
                ,url: "<?php echo e(route('backend.announce.list')); ?>" //数据接口
                ,method: 'get'
                ,where: {
                    'title': title,
                }
...
<?php echo $__env->make('backend.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\phpStudy_64\phpstudy_pro\WWW\www.kbframe.com\resources\views/backend/announce/index.blade.php ENDPATH**/ ?>