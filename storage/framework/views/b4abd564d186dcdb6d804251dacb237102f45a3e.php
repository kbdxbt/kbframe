    ...
    <script>
        layui.config({
            ...
            var dataTable = table.render({
                elem: '#dataTable'
                ,id: 'backendNotify'
                ,url: "<?php echo e(route('backend.notify.list')); ?>" //数据接口
                ,method: 'get'
                ,where: {
                    'title': title,
                }
...
<?php echo $__env->make('backend.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\phpStudy_64\phpstudy_pro\WWW\www.kbframe.com\resources\views/backend/notify/index.blade.php ENDPATH**/ ?>